...
if (isset($_SESSION['nome'])) {
    ...
    $sql = "SELECT profile_picture FROM professores WHERE nome='$nomeUsuario'";
...
<div class="menu-bar">
  <ul>
  <li><li>Bem-vindo profe<br> <?php echo $_SESSION['nome']; ?></li></li>
...
<script>
  ...
  $(".dropzone").dropzone({
    url: "uploadP.php", // caminho para o script PHP que irá lidar com o upload da imagem
